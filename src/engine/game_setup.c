...
/*   Updated: 2025/06/23 05:21:51 by abbouras         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @param instance Pointeur vers la structure principale du jeu contenant les données de carte
 * @return void
 */
...
/**
 * Analyse l'ensemble de la carte de jeu pour compter les objets collectables (caractères 'C').
...
/**
 * Initialise le composant carte du jeu en chargeant les données de niveau depuis un fichier.
 * Alloue la mémoire pour la structure de carte, charge le contenu de la carte et valide
